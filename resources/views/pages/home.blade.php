...
@section('content')
    ...
    <section id="Popular" class="flex flex-col gap-4">
        ...
        <div class="swiper w-full overflow-x-hidden">
            <div class="swiper-wrapper">
                @foreach ($popularBoadingHouse as $boardingHouse)
                                ...
                                <div class="flex flex-col gap-3">
                                    ...
                                    <div class="flex items-center gap-[6px]">
                                        <img src="assets/images/icons/location.svg" class="w-5 h-5 flex shrink-0"
                                            alt="icon">
                                        <p class="text-sm text-ngekos-grey">Location:
                                            {{ $boardingHouse->city_name ?? 'No City' }}</p>
                                    </div>
                                    <div class="flex items-center gap-[6px]">
                                        <img src="assets/images/icons/3dcube.svg" class="w-5 h-5 flex shrink-0"
                                            alt="icon">
                                        <p class="text-sm text-ngekos-grey">In
                                            {{ $boardingHouse->category_name ?? 'No Category' }}</p>
                                    </div>
                                    <div class="flex items-center gap-[6px]">
